...
func (s *SmsService) Send(ctx context.Context, params SendSmsParams, idempotencyKey string) (*SendSmsResponse, error) {
	...
	if err := s.client.request(ctx, http.MethodPost, "/sms", params, &result, headers); err != nil { return nil, err }
	return &result, nil
}
...
func (s *SmsService) BatchSend(ctx context.Context, params []SendSmsParams, idempotencyKey string) ([]SendSmsResponse, error) {
	...
	if idempotencyKey != "" { headers.Set("Idempotency-Key", idempotencyKey) }
	var result []SendSmsResponse
	if err := s.client.request(ctx, http.MethodPost, "/sms/batch", params, &result, headers); err != nil { return nil, err }
	return result, nil
}

func (s *SmsService) Get(ctx context.Context, id string) (*SmsMessage, error) {
	var result SmsMessage
	if err := s.client.request(ctx, http.MethodGet, "/sms/"+url.PathEscape(id), nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}

func (s *SmsService) Analytics(ctx context.Context) (*SmsAnalytics, error) {
	var result SmsAnalytics
	if err := s.client.request(ctx, http.MethodGet, "/sms/analytics", nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *SmsService) Update(ctx context.Context, id string, params UpdateSmsParams) (*SendSmsResponse, error) {
	var result SendSmsResponse
	if err := s.client.request(ctx, http.MethodPatch, "/sms/"+url.PathEscape(id), params, &result, nil); err != nil { return nil, err }
	return &result, nil
}

func (s *SmsService) Cancel(ctx context.Context, id string) (*SendSmsResponse, error) {
	var result SendSmsResponse
	if err := s.client.request(ctx, http.MethodPost, "/sms/"+url.PathEscape(id)+"/cancel", nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *SmsService) SyncStatus(ctx context.Context, id string) (*SmsMessage, error) {
	var result SmsMessage
	if err := s.client.request(ctx, http.MethodPost, "/sms/"+url.PathEscape(id)+"/sync-status", nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
