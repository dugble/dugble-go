...
type SendBroadcastParams struct { ScheduledAt string `json:"scheduled_at,omitempty"` }
type DuplicateBroadcastParams struct { Name string `json:"name,omitempty"` }
type PreviewBroadcastParams struct { Variables map[string]any `json:"variables,omitempty"` }
...
func (s *BroadcastsService) Create(ctx context.Context, params CreateBroadcastParams) (*Broadcast, error) {
	...
	if err := s.client.request(ctx, http.MethodPost, "/broadcasts", params, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) List(ctx context.Context, params ListBroadcastsParams) ([]Broadcast, error) {
	var result []Broadcast
	if err := s.client.request(ctx, http.MethodGet, "/broadcasts"+paginationQuery(params.Limit, params.Offset), nil, &result, nil); err != nil { return nil, err }
	return result, nil
}
func (s *BroadcastsService) Get(ctx context.Context, id string) (*Broadcast, error) {
	var result Broadcast
	if err := s.client.request(ctx, http.MethodGet, "/broadcasts/"+url.PathEscape(id), nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) Update(ctx context.Context, id string, params UpdateBroadcastParams) (*Broadcast, error) {
	var result Broadcast
	if err := s.client.request(ctx, http.MethodPatch, "/broadcasts/"+url.PathEscape(id), params, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) Delete(ctx context.Context, id string) (*Broadcast, error) {
	var result Broadcast
	if err := s.client.request(ctx, http.MethodDelete, "/broadcasts/"+url.PathEscape(id), nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) Send(ctx context.Context, id string, params SendBroadcastParams) (*Broadcast, error) {
	var body any
	if params.ScheduledAt != "" { body = params }
	var result Broadcast
	if err := s.client.request(ctx, http.MethodPost, "/broadcasts/"+url.PathEscape(id)+"/send", body, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) Cancel(ctx context.Context, id string) (*Broadcast, error) {
	var result Broadcast
	if err := s.client.request(ctx, http.MethodPost, "/broadcasts/"+url.PathEscape(id)+"/cancel", nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) Duplicate(ctx context.Context, id string, params DuplicateBroadcastParams) (*Broadcast, error) {
	var result Broadcast
	if err := s.client.request(ctx, http.MethodPost, "/broadcasts/"+url.PathEscape(id)+"/duplicate", params, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) Preview(ctx context.Context, id string, params PreviewBroadcastParams) (*BroadcastPreview, error) {
	var body any
	if params.Variables != nil { body = params }
	var result BroadcastPreview
	if err := s.client.request(ctx, http.MethodPost, "/broadcasts/"+url.PathEscape(id)+"/preview", body, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *BroadcastsService) Exclusions(ctx context.Context, id string) (*BroadcastExclusionSummary, error) {
	...
	if err := s.client.request(ctx, http.MethodGet, "/broadcasts/"+url.PathEscape(id)+"/exclusions", nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
func (s *BroadcastsService) Analytics(ctx context.Context, id string) (*BroadcastAnalytics, error) {
	var result BroadcastAnalytics
	if err := s.client.request(ctx, http.MethodGet, "/broadcasts/"+url.PathEscape(id)+"/analytics", nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
