...
func (s *SuppressionsService) Create(ctx context.Context, params CreateSuppressionParams) (*SuppressionMutationResponse, error) {
	...
	if err := s.client.request(ctx, http.MethodPost, "/suppressions", params, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *SuppressionsService) Get(ctx context.Context, identifier string) (*Suppression, error) {
	...
	if err := s.client.request(ctx, http.MethodGet, "/suppressions/"+url.PathEscape(identifier), nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *SuppressionsService) Delete(ctx context.Context, identifier string) (*SuppressionDeleteResponse, error) {
	...
	if err := s.client.request(ctx, http.MethodDelete, "/suppressions/"+url.PathEscape(identifier), nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *SuppressionsService) BatchAdd(ctx context.Context, params BatchAddSuppressionsParams) (*BatchAddSuppressionsResponse, error) {
	...
	if err := s.client.request(ctx, http.MethodPost, "/suppressions/batch/add", params, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *SuppressionsService) BatchRemove(ctx context.Context, params BatchRemoveSuppressionsParams) (*BatchRemoveSuppressionsResponse, error) {
	...
	if err := s.client.request(ctx, http.MethodPost, "/suppressions/batch/remove", params, &result, nil); err != nil { return nil, err }
	return &result, nil
}
