...
func (s *ContactPropertiesService) Get(ctx context.Context, id string) (*ContactProperty, error) {
	...
	if err := s.client.request(ctx, http.MethodGet, "/contact-properties/"+url.PathEscape(id), nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *ContactPropertiesService) Update(ctx context.Context, id string, params UpdateContactPropertyParams) (*ContactPropertyMutationResponse, error) {
	var result ContactPropertyMutationResponse
	if err := s.client.request(ctx, http.MethodPatch, "/contact-properties/"+url.PathEscape(id), params, &result, nil); err != nil { return nil, err }
	return &result, nil
}
...
func (s *ContactPropertiesService) Delete(ctx context.Context, id string) (*ContactPropertyDeleteResponse, error) {
	...
	if err := s.client.request(ctx, http.MethodDelete, "/contact-properties/"+url.PathEscape(id), nil, &result, nil); err != nil { return nil, err }
	return &result, nil
}
